...
const Header = () => {
    ...
    return (
        <div className={`${css.Header} ${css.bodyOne} ${css.one} `}>
            <p>MY MOVIES SITE</p>
            <NavLink to={'movies'} className={`${darkTheme ? css.dark : ''}`}>Movies</NavLink>
            <NavLink to={'genres'} className={`${darkTheme ? css.dark : ''}`}>Genres</NavLink>
            <NavLink to={'search'} className={`${darkTheme ? css.dark : ''}`}>Search</NavLink>
            <p>Theme</p>
